                ...
                <AnimatePresence>
                    {showPicker && (
                        <motion.div
                            ...
                            className="absolute bottom-full left-0 mb-2 w-80 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden z-50"
                        >
                            {/* Search */}
                            ...
                            <div className="max-h-48 overflow-y-auto">
                                {availableQuestions.map((q) => (
                                    <button
                                        ...
                                        className="w-full flex items-center gap-2 px-3 py-2 text-xs text-slate-900 hover:bg-slate-200 hover:text-slate-900 transition-colors text-left"
                                    >
                                        {q.is_template
                                            ? <Star size={11} className="text-amber-400 flex-shrink-0" fill="currentColor" />
                                            : <MessageSquarePlus size={11} className="text-slate-900 flex-shrink-0" />
                                        }
