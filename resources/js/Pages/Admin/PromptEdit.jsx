...
const COMMON_VARS = [
    ...
    "datos_transporte_googlemaps", "datos_parkings_googlemaps", "contexto_secciones_anteriores",
...
const EXAMPLE_VALUES = {
    ...
    datos_transporte_googlemaps: "Metro L8 (Campo de las Naciones, 350m) · Bus 122, 140 · Cercanías C1 (Chamartín, 1.2km)",
    datos_parkings_googlemaps: "Parking IFEMA (1.200 plazas, 300m). Tel: +34 917 22 04 00 · Parking Valdebebas (800 plazas, 1.5km)",
                                ...
                                <div className="space-y-1.5 pt-1">
                                    {[
                                        ...
                                        <div key={name} className={`flex gap-2 p-2 rounded-lg transition-colors ${data.model === name ? "bg-[#208DCA]/8 border border-[#208DCA]/15" : "opacity-40"}`}>
                                            ...
                                            <span className="text-[10px] text-slate-900 leading-snug">{desc}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                                        ...
                                        {[
                                            ...
                                            <div key={range} className="flex items-start gap-2">
                                                ...
                                                <div>
                                                    ...
                                                    <span className="text-[10px] text-slate-900"> — {hint}</span>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                            ...
                            <button
                                ...
                                className={`flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg border transition-all ${
                                    showPreview
                                        ...
                                        : "bg-white border-slate-200 text-slate-900 hover:text-slate-900 hover:bg-slate-200"
                                }`}
                            >
