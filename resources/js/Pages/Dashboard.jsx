    ...
    return (
        <AppLayout>
            <div className="px-8 py-8 max-w-6xl mx-auto">
                ...
                >
                    <div>
                        <p className="text-gray-400 text-sm mb-1">Bienvenido, {auth?.user?.name}</p>
                ...
                {plans.length === 0 ? (
                    <motion.div
                        className="relative overflow-hidden rounded-2xl border border-gray-200 text-center py-24"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        ...
                        <AnimatePresence>
                            {plans.map((plan, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        <Shine
                                            className="relative overflow-hidden rounded-2xl border border-gray-200 bg-gray-50 hover:bg-gray-100 hover:border-gray-200 transition-all duration-300 p-5"
                                        ...
                                        >
                                            ...
                                            <div className="relative">
                                                ...
                                                <div className="flex items-start justify-between mb-4">
                                                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#273887]/30 to-[#208DCA]/30 flex items-center justify-center border border-[#208DCA]/20">
                                                ...
                                                <p className="text-xs text-gray-400 font-mono mb-3">{plan.uuid}</p>

                                                <div className="flex items-center gap-2 mb-4">
                                                    <span className={`inline-flex items-center px-2 py-0.5 rounded-md text-xs font-medium border ${status.color}`}>
                                                        {status.label}
                                                    </span>
                                                    <span className="text-xs text-gray-400 ml-auto">{plan.created_at}</span>
                                                </div>
                                                ...
                                                <Link href={`/planes/${plan.uuid}/seccion/1`}>
                                                    <RippleButton
                                                        className="w-full bg-gray-100 hover:bg-gray-100 text-gray-800 border border-gray-200 gap-1.5 h-8 text-xs font-medium"
